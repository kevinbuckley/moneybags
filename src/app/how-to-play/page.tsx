...
export const metadata: Metadata = {
  title: "How to Play",
  description:
    "Learn how to simulate market crashes and bull runs in Mr. Moneybags. Pick a scenario, build a portfolio, set trading rules, and watch your fake money disappear.",
};
